...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Unified parser for Hugging Face models: normalization, enrichment, "
    ...
    parser.add_argument(
        ...
        help="Source JSON file (default: models.json)",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=default_base_dir / "models_parsed.json",
        help="Output JSON file (default: models_parsed.json)",
    )
    parser.add_argument(
        "--in-place",
        action="store_true",
