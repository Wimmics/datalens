...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Fix dcterms:identifier to match the id in dcat:landingPage (preserves '__')."  # Corrects mismatched identifiers
    )
    parser.add_argument(
        "files",
        nargs="*",
        help="TTL files to process. If omitted, defaults to xr2rml_output/datasets/datasets_extract.ttl",
    )
